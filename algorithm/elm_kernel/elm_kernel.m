...
%result = elm_kernel('HOG14500trainx5','HOG14100testx5',1,100,'RBF_kernel',1000);
% 88.4%

%result = elm_kernel('HOG14trainnew','HOG14testnew',1,100,'RBF_kernel',1000);
%100%!!!!!!!!!!!!!!!!!!!!
...
train_data=Gaborspeedlimitstrain;
T=train_data(:,1)';
P=train_data(:,2:size(train_data,2))';
clear Gaborspeedlimitstrain;                                   %   Release raw training data array

%%%%%%%%%%% Load testing dataset
load(TestingData_File);
test_data=Gaborspeedlimitstest;
TV.T=test_data(:,1)';
TV.P=test_data(:,2:size(test_data,2))';
clear Gaborspeedlimitstest;                                    %   Release raw testing data array
...
OutputWeight=((Omega_train+speye(n)/C)\(T')); 			%sparse identity matrix
TrainingTime=toc
